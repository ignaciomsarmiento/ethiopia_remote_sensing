...
#evaluation
load(here("data/results/kshape_regions_undersampling.RData"))
...
load(here("data/results/kshape_undersampling.RData"))
...
stargazer(data.frame(Results),summary=FALSE, rownames=FALSE,type="latex",digits=2,out=here("views/eval_undersampling.tex"))

stargazer(data.frame(Results_long),summary=FALSE, rownames=FALSE,type="latex",digits=2,out=here("views/eval_undersampling_max_cluster.tex"))
