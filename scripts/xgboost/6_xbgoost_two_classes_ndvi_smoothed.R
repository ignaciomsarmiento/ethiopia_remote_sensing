...
dta<- dta %>% mutate(land_use=ifelse(land_use=="Improved forage","Improv_forage","Other"))
...
covariate_names<-covariate_names[grepl('ndvi',covariate_names)==TRUE]
covariate_names<-covariate_names[grepl('w_center',covariate_names)==TRUE]
covariate_names
...
save.image(here("data/results/singleclass_xgboost_ndvi_smoothed.RData"))
